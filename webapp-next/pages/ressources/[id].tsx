...
const RessourcePage: React.FC<Props> = ({ ressource, similarRessources }) => {
	...
	const ressourceBody = <Box>
		{ressource.kind === 'video' && (
			ressource.source === 'youtube' && (
				<Box mb={8}>
					<iframe width="100%" height="450px"
						src={`https://www.youtube.com/embed/${getYoutubeIdFromFullUrl(ressource.link)}?modestbranding=1&autohide=1&showinfo=0&controls=0`}
